  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-900 p-6">
      ...
      <div className="mt-6 w-full max-w-md flex flex-col gap-3">
        ...
        <Link href="/Produto" className="bg-gray-500 text-white text-center py-2 rounded-lg hover:bg-blue-600 transition">
          Cadastro de Produtos
        </Link>

        <Link href="/Cliente" className="bg-gray-500 text-white text-center py-2 rounded-lg hover:bg-green-600 transition">
        ...
        <Link href="/Fornecedores" className="bg-gray-500 text-white text-center py-2 rounded-lg hover:bg-gray-600 transition">
          Cadastro de Fornecedores
        </Link>

        <Link href="/IMC" className="bg-gray-500 text-white text-center py-2 rounded-lg hover:bg-yellow-600 transition">
          Calcular IMC
        </Link>

        <Link href="/idade" className="bg-gray-500 text-white text-center py-2 rounded-lg hover:bg-pink-600 transition">
          Calcular Idade
        </Link>

        <Link href="/ficha" className="bg-gray-500 text-white text-center py-2 rounded-lg hover:bg-red-700 transition">
          Ficha de Cadastro
        </Link>
